...
def ask_for_password():
    ...
    entered_password = input(f"{BOLD}{GREEN}By entering the password listed above, you agree to all of the legal disclaimers in red: {RESET}")
